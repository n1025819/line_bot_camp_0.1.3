...
create_line_bot()
{
docker run --user root --name line-chat-bot-jupyter -p 8888:8888 -p 80:5000 -v $(pwd)/material:/home/jovyan/work -e GRANT_SUDO=yes -e NB_UID=1001 -d $USERNAME/$IMAGE:$version start-notebook.sh --NotebookApp.token=''
